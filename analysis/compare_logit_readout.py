...
"""
python /root/py/multidiag_remote/DGFDBenchmark_uored/analysis/compare_logit_readout.py \
  ...
  --outdir /root/py/multidiag_remote/analysis_outputs/compare_logit_readout
"""